...
var useIsomorphicLayoutEffect =
  ...
  typeof window.document.createElement !== 'undefined'
    ...
    : react.useEffect; // assign current value to a ref and providing a getter.
...
var useAsyncState = function useAsyncState(options) {
  ...
  var setLoading = react.useCallback(
    function() {
      return setValue(options.setLoading(value));
    },
    [value, setValue]
  );
  var setResult = react.useCallback(
    function(result) {
